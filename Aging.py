...
t_Alb = [bef_sand, aft_sand, 25.,  78.,  215., 353.,  1333., 1724., 3133., 7044., 17380., 27525.]
t_Alb_thr = [bef_sand, 15., 57., 132., 280., 436., 1439., 1847., 3280., 7208., 17554., 27706.]
QE_Alb= [0.65,     66.1,     35.5, 21.6, 16.3, 14.1,  7.93,  5.93,  3.41,  1.80,  1.08,   0.61]
t_S4  = [bef_sand, aft_sand, 25.,  150., 289., 1228., 1662., 2961., 6939., 17269., 19895, 30025.]
t_S4_thr = [bef_sand, 9.0, 55.0, 228., 387., 1385., 1841., 3157., 7153., 17505., 20194., 27655.]
QE_S4 = [0.85,     57.9,     30.3, 10.3, 7.55, 2.81,  1.97,  1.38,  1.11,  0.43,   0.37,  0.23]

# Measurement from Aug.10
t_Zn  = [aft_sand, 45.,  133., 251., 1071., 1542., 5534., 15855., 25992.]
t_Zn_thr = [10.0,  73.,  173., 307., 1147., 1642., 5650., 15996., 26143.]
QE_Zn = [96.1,     46.1, 28.4, 15.6, 7.06,  4.78,  2.02,  1.13,   0.52]
...
t_B1  = [121., 1689., 2985., 7207.]
QE_B1 = [27.0, 18.6,  15.1,  13.3]
t_S6  = [152., 1652., 2953., 6984.]
QE_S6 = [14.0, 6.60,  5.14,  5.12]
t_B2  = [57.,  352.,  4576.]
QE_B2 = [22.4, 13.2,  5.07]
t_S7  = [86.,  381.,  4604.]
QE_S7 = [16.7, 8.06,  5.69]
t_B3  = [118., 4284.]
QE_B3 = [12.4, 4.55]
...
if not args.plot_N2:
    ...
    #plt.xlabel("Time after sanding [hrs]")
else:
    ...
    plot_and_fit(t_B3, QE_B3, "Vivid B3", 'g', '^', bFit)
